...
image::images/state_veg_maps_2021-20839.png[]
Image courtesy of NSW DPIE

Home of this doc https://github.com/billjwilliamson/cd_terra/blob/master/viridarii/state_veg_maps_2021/state_veg_maps_2021.asciidoc
...
_https://github.com/billjwilliamson/cd_terra/blob/master/viridarii/state_veg_maps_2021/configure_01_v.state_veg_map_2021.txt[GDAL commands via QGIS - GitHub Link]_
```
include::configure_01_v.state_veg_map_2021.sh[]
```

## Cleanup the geometry

_https://github.com/billjwilliamson/cd_terra/blob/master/viridarii/state_veg_maps_2021/configure_02_v.state_veg_map_2021.sql[Make the geometry valid - GitHub Link]_
```sql
include::configure_02_v.state_veg_map_2021.sql[]
```
...
image::images/explain_plan_1644353258192.svg[]

_https://github.com/billjwilliamson/cd_terra/blob/master/viridarii/state_veg_maps_2021/configure_03_v.state_veg_map_2021.sql[Make one table - GitHub Link]_
```sql
include::configure_03_v.state_veg_map_2021.sql[]
```
...
_clean up_
```sql
include::cleanup_51_v.state_veg_map_2021.sql[]
```
...
```sql
include::qa_41_v.state_veg_map_2021.sql[]
```

_qa results by formation_
[%header,format=csv,cols="<3,>1"]
|===
include::qa_results/state_veg_maps_2021_qa_area_by_formation.csv[]
|===

_qa results by mapsource_
[%header,format=csv,cols="<3,>1"]
|===
include::qa_results/state_veg_maps_2021_qa_area_by_mapsource.csv[]
|===
